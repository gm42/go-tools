...
```
go get github.com/gm42/go-tools/cmd/structlayout
go get github.com/gm42/go-tools/cmd/structlayout-pretty
go get github.com/gm42/go-tools/cmd/structlayout-optimize
```
